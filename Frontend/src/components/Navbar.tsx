...
const Navbar = ({ activeSection }: NavbarProps) => {
  ...
  >
    ...
    className="flex items-center justify-center w-10 h-10 rounded-full border border-gray-200 hover:border-cyan-500 hover:bg-cyan-50 transition-all duration-200"
    ...
    />
          ...
          <div className="relative">
            ...
            <button
              ...
              className="p-2 rounded-lg transition-all duration-200 over:border-cyan-500 hover:bg-cyan-50 transition-all duration-200 active:scale-95"
            >
              {isMenuOpen ? (
